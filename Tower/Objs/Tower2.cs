...
{
	public class Tower2 : MTower
	{
		Texture2D circle;
		GameObject target;

		public Tower2(Vector2 pos)
			: base(pos)
		{
			texture = Utils.get().content.Load<Texture2D>("tower2");
		...
		public override Projectile attack()
		{
			...
			{
				countAttTime = 0;
				return new Projectile2(new Vector2(pos.X + rect.Width / 2, pos.Y + 8), target);
			}
